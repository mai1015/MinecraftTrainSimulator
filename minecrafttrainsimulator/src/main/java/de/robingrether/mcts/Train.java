...
public abstract class Train {
    ...
    public boolean setLeader(Player player) {
        if (player.getVehicle() instanceof Minecart) {
            MinecartMember<?> minecart = MinecartMemberStore.convert(minecarts.getTrainCarts(), (Minecart) player.getVehicle());
    ...
    private void initTrainProperties() {
        ...
        properties.setCollisionMode("playercollision ", "push");
        properties.setCollisionMode("misccollision ", "push");
        properties.setCollisionMode("traincollision ", "push");
